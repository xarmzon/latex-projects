...
\begin{document}
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& \tikzmark{bbbb1}$D_1$ & $D_2$ & $D_3$ & $D_4$ & Supply \\\hline
		\tikzmark{aaaa1}$S_1$ & 100(200) & 50 & 130 & \tikzmark{aaaa2}70 & 0\\\hline
		$S_2$ & 90 & 60 & 80 & 100 & 100\\\hline
		$S_3$ & 150 & 20 & 300 & 100 & 300\\\hline
		$S_3$ & \tikzmark{bbbb2}15 & 12 & 24 & 10 & 30\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 150 & 150 & 130 &  \\\hline
	\end{longtable}
	\linkH{aaaa1}{aaaa2}\linkV{bbbb1}{bbbb2}
	{~}\\[-1.8cm]
	
	\NI The rim values for $S_2=100$ and $D_1=0$ are compared.\\
	The smaller of the two i.e $\min(100,0)=0$ is assigned to $S_2D_1$\\
	This meets the complete demand of $D_1$ and leaves $100-0=100$ units with $S_2$
	
	Table-2
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& \tikzmark{bbbb3}$D_1$ & $D_2$ & $D_3$ & $D_4$ & Supply \\\hline
		\tikzmark{aaaa3}$S_1$ & 100(200) & 50 & 130 & \tikzmark{aaaa4}70 & 0\\\hline
		$S_2$ & 90 & 60 & 80 & 100 & 100\\\hline
		$S_3$ & 150 & 20 & 300 & 100 & 300\\\hline
		$S_3$ & \tikzmark{bbbb4}15 & 12 & 24 & 10 & 30\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 150 & 150 & 130 &  \\\hline
	\end{longtable}
	\linkH{aaaa3}{aaaa4}\linkV{bbbb3}{bbbb4}
	{~}\\[-1.8cm]
	
	\NI The rim values for $S_2 = 100$ and $D_2=150$ are compared\\
	The smaller of the two i.e $\min(100,150)=100$ is assigned to $S_2D_2$\\
	This exhaust the capacity of $S_2$ and leaves $150-100=50$ units wit $D_2$
	
	Table-3
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& \tikzmark{bbbb5}$D_1$ & $D_2$ & $D_3$ & $D_4$ & Supply \\\hline
		\tikzmark{aaaa5}$S_1$ & 100(200) & 50 & 130 & \tikzmark{aaaa6}70 & 0\\\hline
		\tikzmark{cccc1}$S_2$ & 90 & 60(100) & 80 & \tikzmark{cccc2}100 & 0\\\hline
		$S_3$ & 150 & 20 & 300 & 100 & 300\\\hline
		$S_3$ & \tikzmark{bbbb6}15 & 12 & 24 & 10 & 30\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 50 & 150 & 130 &  \\\hline
	\end{longtable}
	\linkH{aaaa5}{aaaa6}\linkV{bbbb5}{bbbb6}\linkH{cccc1}{cccc2}
	{~}\\[-1.8cm]
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& \tikzmark{bbbb7}$D_1$ & \tikzmark{dddd1}$D_2$ & $D_3$ & $D_4$ & Supply \\\hline
		\tikzmark{aaaa7}$S_1$ & 100(200) & 50 & 130 & \tikzmark{aaaa8}70 & 0\\\hline
		\tikzmark{cccc3}$S_2$ & 90 & 60(100) & 80 & \tikzmark{cccc4}100 & 0\\\hline
		$S_3$ & 150 & 20(50) & 300 & 100 & 250\\\hline
		$S_3$ & \tikzmark{bbbb8}15 & \tikzmark{dddd2}12 & 24 & 10 & 30\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 0 & 150 & 130 &  \\\hline
	\end{longtable}
	\linkH{aaaa7}{aaaa8}\linkV{bbbb7}{bbbb8}\linkH{cccc3}{cccc4} \linkVV{dddd1}{dddd2}{2.5}{1.5}
	{~}\\[-1.8cm]
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& \tikzmark{bbbb9}$D_1$ & \tikzmark{dddd3}$D_2$ & \tikzmark{eeee1}$D_3$ & $D_4$ & Supply \\\hline
		\tikzmark{aaaa9}$S_1$ & 100(200) & 50 & 130 & \tikzmark{aaaa10}70 & 0\\\hline
		\tikzmark{cccc5}$S_2$ & 90 & 60(100) & 80 & \tikzmark{cccc6}100 & 0\\\hline
		$S_3$ & 150 & 20(50) & 300(150) & 100 & 100\\\hline
		$S_3$ & \tikzmark{bbbb10}15 & \tikzmark{dddd4}12 & \tikzmark{eeee2}24 & 10 & 30\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 0 & 0 & 130 &  \\\hline
	\end{longtable}
	\linkH{aaaa9}{aaaa10}\linkV{bbbb9}{bbbb10}\linkH{cccc5}{cccc6} \linkVV{dddd3}{dddd4}{2.5}{1.5}\linkVV{eeee1}{eeee2}{2.5}{1.5}
	{~}\\[-1.8cm]
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& \tikzmark{bbbb11}$D_1$ & \tikzmark{dddd5}$D_2$ & \tikzmark{eeee3}$D_3$ & $D_4$ & Supply \\\hline
		\tikzmark{aaaa11}$S_1$ & 100(200) & 50 & 130 & \tikzmark{aaaa12}70 & 0\\\hline
		\tikzmark{cccc7}$S_2$ & 90 & 60(100) & 80 & \tikzmark{cccc8}100 & 0\\\hline
		\tikzmark{ffff1}$S_3$ & 150 & 20(50) & 300(150) & \tikzmark{ffff2}100(100) & 0\\\hline
		$S_3$ & \tikzmark{bbbb12}15 & \tikzmark{dddd6}12 & \tikzmark{eeee4}24 & 10 & 30\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 0 & 0 & 30 &  \\\hline
	\end{longtable}
	\linkH{aaaa11}{aaaa12}\linkV{bbbb11}{bbbb12}\linkH{cccc7}{cccc8} \linkVV{dddd5}{dddd6}{2.5}{1.5}\linkVV{eeee3}{eeee4}{2.5}{1.5}\linkH{ffff1}{ffff2}
	{~}\\[-1.8cm]
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& \tikzmark{bbbb13}$D_1$ & \tikzmark{dddd7}$D_2$ & \tikzmark{eeee5}$D_3$ & \tikzmark{hhhh1}$D_4$ & Supply \\\hline
		\tikzmark{aaaa13}$S_1$ & 100(200) & 50 & 130 & \tikzmark{aaaa14}70 & 0\\\hline
		\tikzmark{cccc9}$S_2$ & 90 & 60(100) & 80 & \tikzmark{cccc10}100 & 0\\\hline
		\tikzmark{ffff3}$S_3$ & 150 & 20(50) & 300(150) & \tikzmark{ffff4}100(100) & 0\\\hline
		\tikzmark{gggg1}$S_3$ & \tikzmark{bbbb14}15 & \tikzmark{dddd8}12 & \tikzmark{eeee6}24 & \tikzmark{gggg2}10(30) & 0\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 0 & 0 & 0 &  \\\hline
	\end{longtable}
	\linkH{aaaa13}{aaaa14}\linkV{bbbb13}{bbbb14}\linkH{cccc9}{cccc10} \linkVV{dddd7}{dddd8}{2.5}{1.5}\linkVV{eeee5}{eeee6}{2.5}{1.5}\linkH{ffff3}{ffff4}\linkH{gggg1}{gggg2}\linkVV{hhhh1}{gggg2}{2.5}{5.5}
	{~}\\[-1.8cm]
	\newpage
	\NI Initial feasible solution is  
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& $D_1$ & $D_2$ & $D_3$ & $D_4$ & Supply \\\hline
		$S_1$ & 100(200) & 50 & 130 & 70 & 200\\\hline
		$S_2$ & 90 & 60(100) & 80 & 100 & 100\\\hline
		$S_3$ & 150 & 20(50) & 300(150) & 100(100) & 300\\\hline
	...
	\begin{gather*}
		100 \times 200 + 60 \times 100 + 20 \times 50 + 300 \times 150 + 100 \times 100 + 10 \times 30 = 82300
	\end{gather*}
	Here, the number of allocated cells = 6 which is one less than to $m+n-1= 4+4-1= 7$\\
	$\therefore$ The solution is degenerate.\sps
	\newpage
	\NI\ubt{METHOD 2} Using Lease Cost Method\\
	TOTAL number of supply constraints: 4\\
	TOTAL number of demand constraints: 4\\
	{~}\\[-0.5cm]
	Problem Table is
	...
	This exhausts the capacity of $S_4$ and leaves $130-30=100$ units with $D_4$\\[-0.5cm]
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		...
		$S_2$ & 90 & 60 & 80 & 100 & 100\\\hline
		$S_3$ & 150 & 20 & 300 & 100 & 300\\\hline
		\tikzmark{aaaaa1}$S_3$ & 15 & 12 & 24 & \tikzmark{aaaaa2}10(30) & 0\\\hhline{|=|=|=|=|=#=|}
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& $D_1$ & \tikzmark{bbbbb1}$D_2$ & $D_3$ & $D_4$ & Supply \\\hline
		$S_1$ & 100 & 50 & 130 & 70 & 200\\\hline
		$S_2$ & 90 & 60 & 80 & 100 & 100\\\hline
		$S_3$ & 150 & 20(150) & 300 & 100 & 150\\\hline
		\tikzmark{aaaaa3}$S_3$ & 15 & \tikzmark{bbbbb2}12 & 24 & \tikzmark{aaaaa4}10(30) & 0\\\hhline{|=|=|=|=|=#=|}
		Demand & 200 & 0 & 150 & 100 &  \\\hline
	\end{longtable}
	\linkH{aaaaa3}{aaaaa4}\linkV{bbbbb1}{bbbbb2}
	{~}\\[-1.8cm]
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& $D_1$ & \tikzmark{bbbbb3}$D_2$ & $D_3$ & \tikzmark{ccccc1}$D_4$ & Supply \\\hline
		$S_1$ & 100 & 50 & 130 & 70(100) & 100\\\hline
		$S_2$ & 90 & 60 & 80 & 100 & 100\\\hline
		$S_3$ & 150 & 20(150) & 300 & 100 & 150\\\hline
		\tikzmark{aaaaa5}$S_3$ & 15 & \tikzmark{bbbbb4}12 & 24 & \tikzmark{aaaaa6}10(30) & 0\\\hhline{|=|=|=|=|=#=|}
		Demand & 200 & 0 & 150 & 0 &  \\\hline
	\end{longtable}
	\linkH{aaaaa5}{aaaaa6}\linkV{bbbbb3}{bbbbb4}\linkVV{ccccc1}{aaaaa6}{2.5}{5.5}
	{~}\\[-1.8cm]
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& $D_1$ & \tikzmark{bbbbb5}$D_2$ & $D_3$ & \tikzmark{ccccc2}$D_4$ & Supply \\\hline
		$S_1$ & 100 & 50 & 130 & 70(100) & 100\\\hline
		\tikzmark{ddddd1}$S_2$ & 90 & 60 & 80(100) & \tikzmark{ddddd2}100 & 0\\\hline
		$S_3$ & 150 & 20(150) & 300 & 100 & 150\\\hline
		\tikzmark{aaaaa7}$S_3$ & 15 & \tikzmark{bbbbb6}12 & 24 & \tikzmark{aaaaa8}10(30) & 0\\\hhline{|=|=|=|=|=#=|}
		Demand & 200 & 0 & 50 & 0 &  \\\hline
	\end{longtable}
	\linkH{aaaaa7}{aaaaa8}\linkV{bbbbb5}{bbbbb6}\linkVV{ccccc2}{aaaaa8}{2.5}{5.5}\linkH{ddddd1}{ddddd2}
	{~}\\[-1.8cm]
	
	\NI The smallest transportation cost is 100 in cell $S_1D_1$\\
	The allocation to this cell is $\min(100,200)=100$\\
	This exhausts the capacity of $S_1$ and leaves $200-100=100$ units with $D_1$\\
	
	Table-5
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& $D_1$ & \tikzmark{bbbbb7}$D_2$ & $D_3$ & \tikzmark{ccccc3}$D_4$ & Supply \\\hline
		\tikzmark{eeeee1}$S_1$ & 100(100) & 50 & 130 & \tikzmark{eeeee2}70(100) & 0\\\hline
		\tikzmark{ddddd3}$S_2$ & 90 & 60 & 80(100) & \tikzmark{ddddd4}100 & 0\\\hline
		$S_3$ & 150 & 20(150) & 300 & 100 & 150\\\hline
		\tikzmark{aaaaa9}$S_3$ & 15 & \tikzmark{bbbbb8}12 & 24 & \tikzmark{aaaaa10}10(30) & 0\\\hhline{|=|=|=|=|=#=|}
		Demand & 100 & 0 & 50 & 0 &  \\\hline
	\end{longtable}
	\linkH{aaaaa9}{aaaaa10}\linkV{bbbbb7}{bbbbb8}\linkVV{ccccc3}{aaaaa10}{2.5}{5.5}\linkH{ddddd3}{ddddd4}\linkH{eeeee1}{eeeee2}
	{~}\\[-1.8cm]
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& \tikzmark{fffff1}$D_1$ & \tikzmark{bbbbb9}$D_2$ & $D_3$ & \tikzmark{ccccc4}$D_4$ & Supply \\\hline
		\tikzmark{eeeee3}$S_1$ & 100(100) & 50 & 130 & \tikzmark{eeeee4}70(100) & 0\\\hline
		\tikzmark{ddddd5}$S_2$ & 90 & 60 & 80(100) & \tikzmark{ddddd6}100 & 0\\\hline
		$S_3$ & 150(100) & 20(150) & 300 & 100 & 50\\\hline
		\tikzmark{aaaaa11}$S_3$ & \tikzmark{fffff2}15 & \tikzmark{bbbbb10}12 & 24 & \tikzmark{aaaaa12}10(30) & 0\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 0 & 50 & 0 &  \\\hline
	\end{longtable}
	\linkH{aaaaa11}{aaaaa12}\linkV{bbbbb9}{bbbbb10}\linkVV{ccccc4}{aaaaa12}{2.5}{5.5}\linkH{ddddd5}{ddddd6}\linkH{eeeee3}{eeeee4}\linkVV{fffff1}{fffff2}{2.5}{1.8}
	{~}\\[-1.8cm]
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.55cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{3cm}|}
		\hline
		& \tikzmark{fffff3}$D_1$ & \tikzmark{bbbbb11}$D_2$ & $D_3$ & \tikzmark{ccccc5}$D_4$ & Supply \\\hline
		\tikzmark{eeeee5}$S_1$ & 100(100) & 50 & 130 & \tikzmark{eeeee6}70(100) & 0\\\hline
		\tikzmark{ddddd7}$S_2$ & 90 & 60 & 80(100) & \tikzmark{ddddd8}100 & 0\\\hline
		\tikzmark{ggggg1}$S_3$ & 150(100) & 20(150) & 300(50) & \tikzmark{ggggg2}100 & 0\\\hline
		\tikzmark{aaaaa13}$S_3$ & \tikzmark{fffff4}15 & \tikzmark{bbbbb12}12 & 24 & \tikzmark{aaaaa14}10(30) & 0\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 0 & 0 & 0 &  \\\hline
	\end{longtable}
	\linkH{aaaaa13}{aaaaa14}\linkV{bbbbb11}{bbbbb12}\linkVV{ccccc5}{aaaaa14}{2.5}{5.5}\linkH{ddddd7}{ddddd8}\linkH{eeeee5}{eeeee6}\linkVV{fffff3}{fffff4}{2.5}{1.8}\linkH{ggggg1}{ggggg2}
	{~}\\[-1.8cm]
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.37cm}|>{\centering\arraybackslash}m{1.95cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}||>{\centering\arraybackslash}m{1.47cm}|m{2.2cm}|}
		\hline
		& $D_1$ & \tikzmark{aaaaaa1}$D_2$ & $D_3$ & $D_4$ & Capacity & Row Penalty\\\hline
		$S_1$ & 100 & 50 & 130 & 70 & 200 & 30=100-70\\\hline
		$S_2$ & 90 & 60 & 80 & 100 & 100 & 10=90-80\\\hline
		$S_3$ & 150 & 20(150) & 300 & 100 & 150 & 50=150-100\\\hline
		$S_4$ & 15 & \tikzmark{aaaaaa2}12 & 24 & 10 & 30 & 5-15-10\\\hhline{|=|=|=|=|=#=|=|}
		Demand & 200 & 0 & 150 & 130 & & \\\hline
		Column Penalty & 75=90-15 & - & 56=80-24 & 60=70-10 & &\\\hline
	\end{longtable}
	\linkVV{aaaaaa1}{aaaaaa2}{2.5}{2.6}
	{~}\\[-1cm]
	The maximum penalty, 75 occurs in column $D_1$\\
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.37cm}|>{\centering\arraybackslash}m{1.95cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}||>{\centering\arraybackslash}m{1.47cm}|m{2.2cm}|}
		\hline
		& $D_1$ & \tikzmark{aaaaaa3}$D_2$ & $D_3$ & $D_4$ & Capacity & Row Penalty\\\hline
		$S_1$ & 100 & 50 & 130 & 70 & 200 & 30=100-70\\\hline
		$S_2$ & 90 & 60 & 80 & 100 & 100 & 10=90-80\\\hline
		$S_3$ & 150 & 20(150) & 300 & 100 & 150 & 50=150-100\\\hline
		\tikzmark{bbbbbb1}$S_4$ & 15(30) & \tikzmark{aaaaaa4}12 & 24 & \tikzmark{bbbbbb2}10 & 0 & -\\\hhline{|=|=|=|=|=#=|=|}
		Demand & 170 & 0 & 150 & 130 & & \\\hline
		Column Penalty & 10=100-90 & - & 50=130-80 & 30=100-70 & &\\\hline
	\end{longtable}
	\linkVV{aaaaaa3}{aaaaaa4}{2.5}{2.6}\linkH{bbbbbb1}{bbbbbb2}
	{~}\\[-1cm]
	The maximum penalty, 50 occurs in column $D_3$\\
	The minimum $C_{ij}$ in this column is $C_{23}=80$\\
	The maximum allocation in this cell is $\min(100,50)=50$\\
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.37cm}|>{\centering\arraybackslash}m{1.95cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}||>{\centering\arraybackslash}m{1.47cm}|m{2.2cm}|}
		\hline
		& $D_1$ & \tikzmark{aaaaaa5}$D_2$ & $D_3$ & $D_4$ & Capacity & Row Penalty\\\hline
		$S_1$ & 100 & 50 & 130 & 70 & 200 & 30=100-70\\\hline
		\tikzmark{cccccc1}$S_2$ & 90 & 60 & 80(100) & \tikzmark{cccccc2}100 & 0 & -\\\hline
		$S_3$ & 150 & 20(150) & 300 & 100 & 150 & 50=150-100\\\hline
		\tikzmark{bbbbbb3}$S_4$ & 15(30) & \tikzmark{aaaaaa6}12 & 24 & \tikzmark{bbbbbb4}10 & 0 & -\\\hhline{|=|=|=|=|=#=|=|}
		Demand & 170 & 0 & 50 & 130 & & \\\hline
		Column Penalty & 50=150-100 & - & 170=300-130 & 30=100-70 & &\\\hline
	\end{longtable}
	\linkVV{aaaaaa5}{aaaaaa6}{2.5}{2.6}\linkH{bbbbbb3}{bbbbbb4}\linkH{cccccc1}{cccccc2}
	{~}\\[-1cm]
	The maximum penalty, 170 occurs in column $D_3$\\
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.37cm}|>{\centering\arraybackslash}m{1.95cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}||>{\centering\arraybackslash}m{1.47cm}|m{2.2cm}|}
		\hline
		& $D_1$ & \tikzmark{aaaaaa7}$D_2$ & \tikzmark{dddddd1}$D_3$ & $D_4$ & Capacity & Row Penalty\\\hline
		$S_1$ & 100 & 50 & 130(50) & 70 & 150 & 30=100-70\\\hline
		\tikzmark{cccccc3}$S_2$ & 90 & 60 & 80(100) & \tikzmark{cccccc4}100 & 0 & -\\\hline
		$S_3$ & 150 & 20(150) & 300 & 100 & 150 & 50=150-100\\\hline
		\tikzmark{bbbbbb5}$S_4$ & 15(30) & \tikzmark{aaaaaa8}12 & \tikzmark{dddddd2}24 & \tikzmark{bbbbbb6}10 & 0 & -\\\hhline{|=|=|=|=|=#=|=|}
		Demand & 170 & 0 & 0 & 130 & & \\\hline
		Column Penalty & 50=150-100 & - & - & 30=100-70 & &\\\hline
	\end{longtable}
	\linkVV{aaaaaa7}{aaaaaa8}{2.5}{2.6}\linkH{bbbbbb5}{bbbbbb6}\linkH{cccccc3}{cccccc4}\linkVV{dddddd1}{dddddd2}{2.5}{2.55}
	{~}\\[-1cm]
	The maximum penalty, 50 occurs in column $D_1$\\
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{1.37cm}|>{\centering\arraybackslash}m{1.95cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}||>{\centering\arraybackslash}m{1.47cm}|m{2.2cm}|}
		\hline
		& $D_1$ & \tikzmark{aaaaaa9}$D_2$ & \tikzmark{dddddd3}$D_3$ & $D_4$ & Capacity & Row Penalty\\\hline
		\tikzmark{eeeeee1}$S_1$ & 100(150) & 50 & 130(50) & \tikzmark{eeeeee2}70 & 0 & -\\\hline
		\tikzmark{cccccc5}$S_2$ & 90 & 60 & 80(100) & \tikzmark{cccccc6}100 & 0 & -\\\hline
		$S_3$ & 150 & 20(150) & 300 & 100 & 150 & 50=150-100\\\hline
		\tikzmark{bbbbbb7}$S_4$ & 15(30) & \tikzmark{aaaaaa10}12 & \tikzmark{dddddd4}24 & \tikzmark{bbbbbb8}10 & 0 & -\\\hhline{|=|=|=|=|=#=|=|}
		Demand & 20 & 0 & 0 & 130 & & \\\hline
		Column Penalty & 150 & - & - & 100 & &\\\hline
	\end{longtable}
	\linkVV{aaaaaa9}{aaaaaa10}{2.5}{2.6}\linkH{bbbbbb7}{bbbbbb8}\linkH{cccccc5}{cccccc6}\linkVV{dddddd3}{dddddd4}{2.5}{2.55}\linkH{eeeeee1}{eeeeee2}
	{~}\\[-1cm]
	The maximum penalty, 150 occurs in column $D_1$\\
