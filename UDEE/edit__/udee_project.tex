...
%	\end{longtable}
	...
	\begin{longtable}{|>{\centering\arraybackslash}m{2.1cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{2.7cm}|}
		...
		Demand & 0 & 300 & 250 & 200 &  \\\hline
	\end{longtable}
	\linkV{j1}{j2}
	{~}\\[-1cm]
	\NI The rim values for $S_1=50$ and $W_2=300$ are compared\\
	The smaller of the two i.e $\min(50,300) = 50$ is assigned to $S_1W_2$\\
	This exhausts the capacity of $S_1$ and leaves $300-50=250$ units with $W_2$\\
	\newpage
	\NI~Table-2
	\begin{longtable}{|>{\centering\arraybackslash}m{2.1cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{2.7cm}|}
		\hline
		& \tikzmark{j3}$W_1$ &$W_2$ & $W_3$ & $W_4$ & Supply\\\hline
		\tikzmark{k1}$S_1$ & 5(350) & 6(50) & 5 &\tikzmark{k2} 7 & 0\\
		$S_2$ & 2 & 2 & 3 & 3 & 150\\
		$S_3$ & 5 & 4 & 4 & 3 & 100\\
		$S_4$ &\tikzmark{j4}13 & 12 & 15 & 12 & 200\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 250 & 250 & 200 &  \\\hline
	\end{longtable}
	\linkV{j3}{j4}\linkH{k1}{k2}
	{~}\\[-1cm]
	\NI The rim values for $S_2=150$ and $W_2=250$ are compared\\
	The smaller of the two i.e $\min(150,250) = 150$ is assigned to $S_2W_2$\\
	This exhausts the capacity of $S_2$ and leaves $250-150=100$ units with $W_2$\\
	
	\NI~Table-3
	\begin{longtable}{|>{\centering\arraybackslash}m{2.1cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{2.7cm}|}
		\hline
		& \tikzmark{j5}$W_1$ &$W_2$ & $W_3$ & $W_4$ & Supply\\\hline
		\tikzmark{k3}$S_1$ & 5(350) & 6(50) & 5 &\tikzmark{k4} 7 & 0\\
		\tikzmark{l1}$S_2$ & 2 & 2(150) & 3 & \tikzmark{l2}3 & 0\\
		$S_3$ & 5 & 4 & 4 & 3 & 100\\
		$S_4$ &\tikzmark{j6}13 & 12 & 15 & 12 & 200\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 100 & 250 & 200 &  \\\hline
	\end{longtable}
	\linkV{j5}{j6}\linkH{k3}{k4}\linkH{l1}{l2}
	{~}\\[-1cm]
	\NI The rim values for $S_3=100$ and $W_2=100$ are compared\\
	The smaller of the two i.e $\min(100,100) = 100$ is assigned to $S_3W_2$\\
	This exhausts the capacity of $S_3$ and leaves $100-100=0$ units with $W_2$\\
	
	\NI~Table-4
	\begin{longtable}{|>{\centering\arraybackslash}m{2.1cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{2.7cm}|}
		\hline
		& \tikzmark{j7}$W_1$ &\tikzmark{n1}$W_2$ & $W_3$ & $W_4$ & Supply\\\hline
		\tikzmark{k5}$S_1$ & 5(350) & 6(50) & 5 &\tikzmark{k6} 7 & 0\\
		\tikzmark{l3}$S_2$ & 2 & 2(150) & 3 & \tikzmark{l4}3 & 0\\
		\tikzmark{m1}$S_3$ & 5 & 4(100) & 4 & \tikzmark{m2}3 & 0\\
		$S_4$ &\tikzmark{j8}13 & \tikzmark{n2}12 & 15 & 12 & 200\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 0 & 250 & 200 &  \\\hline
	\end{longtable}
	\linkV{j7}{j8}\linkH{k5}{k6}\linkH{l3}{l4}\linkH{m1}{m2}\linkV{n1}{n2}
	{~}\\[-1cm]
	\NI The rim values for $S_4=200$ and $W_2=0$ are compared\\
	The smaller of the two i.e $\min(200,0) = 0$ is assigned to $S_4W_2$\\
	This meets the complete demand of $D_2$ and leaves $200-0=200$ units with $S_4$\\
	
	\NI~Table-5
	\begin{longtable}{|>{\centering\arraybackslash}m{2.1cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{2.7cm}|}
		\hline
		& \tikzmark{j9}$W_1$ &\tikzmark{n3}$W_2$ & $W_3$ & $W_4$ & Supply\\\hline
		\tikzmark{k7}$S_1$ & 5(350) & 6(50) & 5 &\tikzmark{k8} 7 & 0\\
		\tikzmark{l5}$S_2$ & 2 & 2(150) & 3 & \tikzmark{l6}3 & 0\\
		\tikzmark{m3}$S_3$ & 5 & 4(100) & 4 & \tikzmark{m4}3 & 0\\
		$S_4$ &\tikzmark{j10}13 & \tikzmark{n4}12 & 15 & 12 & 200\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 0 & 250 & 200 &  \\\hline
	\end{longtable}
	\linkV{j9}{j10}\linkH{k7}{k8}\linkH{l5}{l6}\linkH{m3}{m4}\linkV{n3}{n4}
	{~}\\[-1cm]
	\NI The rim values for $S_4=200$ and $W_3=250$ are compared\\
	The smaller of the two i.e $\min(200,250) = 200$ is assigned to $S_4W_3$\\
	This exhausts the capacity of $S_4$ and leaves $250-200=50$ units with $W_3$\\
	
	\NI~Table-6
	\begin{longtable}{|>{\centering\arraybackslash}m{2.1cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.7cm}|>{\centering\arraybackslash}m{1.4cm}||>{\centering\arraybackslash}m{2.7cm}|}
		\hline
		& \tikzmark{j11}$W_1$ &\tikzmark{n5}$W_2$ & $W_3$ & $W_4$ & Supply\\\hline
		\tikzmark{k9}$S_1$ & 5(350) & 6(50) & 5 &\tikzmark{k10} 7 & 0\\
		\tikzmark{l7}$S_2$ & 2 & 2(150) & 3 & \tikzmark{l8}3 & 0\\
		\tikzmark{m5}$S_3$ & 5 & 4(100) & 4 & \tikzmark{m6}3 & 0\\
		\tikzmark{o1}$S_4$ &\tikzmark{j12}13 & \tikzmark{n6}12 & 15(200) & \tikzmark{o2}12 & 0\\\hhline{|=|=|=|=|=#=|}
		Demand & 0 & 0 & 50 & 200 &  \\\hline
	\end{longtable}
	\linkV{j11}{j12}\linkH{k9}{k10}\linkH{l7}{l8}\linkH{m5}{m6}\linkV{n5}{n6}\linkH{o1}{o2}
	{~}\\[-1cm]
	\NI The rim values for $S_4=200$ and $W_3=250$ are compared\\
	The smaller of the two i.e $\min(200,250) = 200$ is assigned to $S_4W_3$\\
	This exhausts the capacity of $S_4$ and leaves $250-200=50$ units with $W_3$\\
