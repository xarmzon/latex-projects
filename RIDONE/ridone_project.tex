...
\begin{document}
	...
	This project dealt with solving partial Differential Equation of the second order derivative by the application of Laplace Substitution method which is based on the Laplace transform. This method has a convenient way to find exact solution in the less computation is compared with Method of Separation of Variables (MSV) and Variational iteration method (VIM). 
